...
class StrategyTestCase(TestCase):
    ...
    def test_single_moving_average_strategy_when_price_goes_up(self):
        signals = analyze_by_single_moving_average_strategy(self.test_df_1)
        move = advice_move(signals)
        self.assertEqual(move, "SELL")


    def test_single_moving_average_strategy_when_price_goes_down(self):
        signals = analyze_by_single_moving_average_strategy(self.test_df_2)
        move = advice_move(signals)
        self.assertEqual(move, "BUY")


    def test_single_moving_average_strategy_when_price_static(self):
        signals = analyze_by_single_moving_average_strategy(self.test_df_3)
        move = advice_move(signals)
        self.assertEqual(move, "STAND BY")
    

    def test_double_moving_average_strategy_when_price_goes_up(self):
        signals = analyze_by_double_moving_averages_strategy(self.test_df_1)
        move = advice_move(signals)
        self.assertEqual(move, "SELL")


    def test_double_moving_average_strategy_when_price_goes_down(self):
        signals = analyze_by_double_moving_averages_strategy(self.test_df_2)
        move = advice_move(signals)
        self.assertEqual(move, "BUY")


    def test_double_moving_average_strategy_when_price_static(self):
        signals = analyze_by_double_moving_averages_strategy(self.test_df_3)
        move = advice_move(signals)
        self.assertEqual(move, "STAND BY")


    def test_rsi_strategy_when_price_goes_up(self):
        signals = analyze_by_rsi_strategy(self.test_df_1)
        move = advice_move(signals)
        self.assertEqual(move, "BUY")


    def test_rsi_strategy_when_price_goes_down(self):
        signals = analyze_by_rsi_strategy(self.test_df_2)
        move = advice_move(signals)
        self.assertEqual(move, "SELL")


    def test_rsi_strategy_when_price_static(self):
        signals = analyze_by_rsi_strategy(self.test_df_3)
        move = advice_move(signals)
        self.assertEqual(move, "STAND BY")


    def test_mean_reversion_strategy_when_price_goes_up(self):
        signals = analyze_by_mean_reversion_strategy(self.test_df_1)
        move = advice_move(signals)
        self.assertEqual(move, "STAND BY")


    def test_mean_reversion_strategy_when_price_goes_down(self):
        signals = analyze_by_mean_reversion_strategy(self.test_df_2)
        move = advice_move(signals)
        self.assertEqual(move, "STAND BY")


    def test_mean_reversion_strategy_when_price_static(self):
        signals = analyze_by_mean_reversion_strategy(self.test_df_3)
        move = advice_move(signals)
        self.assertEqual(move, "STAND BY")